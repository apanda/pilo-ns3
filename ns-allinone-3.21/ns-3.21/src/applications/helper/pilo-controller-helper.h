...
public:
  /**
   * Create PiloControllerHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   */
  PiloControllerHelper ();
  ...
  PiloControllerHelper (Ipv4Address ip, uint16_t port);
  /**
   *  Create PiloControllerHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  PiloControllerHelper (Ipv6Address ip, uint16_t port);
  /**
   *  Create PiloControllerHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  PiloControllerHelper (Address ip, uint16_t port);
