...
#ifndef PILO_CTLSERVER_H
#define PILO_CTLSERVER_H
 ...
 * \defgroup udpclientserver PiloCtlClientServer
 */
 ...
 */
class PiloCtlServer : public Application
{
public:
  /**
